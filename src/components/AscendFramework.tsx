...
import { ClipboardCheck, Target, Wrench, Play, Compass, Rocket } from "lucide-react";
...
const stages = [
  ...
  },
  {
    ...
    letter: "N",
    name: "Navigate",
    outcome: "Guide the change",
    description: "Support your team through the transition with change management strategies that drive adoption and reduce resistance.",
    timeframe: "Week 7",
  },
  {
    icon: Rocket,
  ...
  return (
    <section ref={sectionRef} className="py-24 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Framework Stages */}
        <div className="grid md:grid-cols-6 gap-4 lg:gap-6 mb-12">
