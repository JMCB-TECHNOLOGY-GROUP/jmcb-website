...
export const metadata = {
  ...
  description: "B2B AI transformation, B2C career acceleration, and ASCEND framework licensing from JMCB Technology.",
};
...
export default function SolutionsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* B2C Solutions */}
      <section id="b2c" className="py-16 md:py-24 bg-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div className="lg:order-2">
              ...
              <p className="text-lg text-gray-600 mb-6">
                For professionals who want to build careers that compound over time. Coaching, frameworks, and resources to help you move faster and with more intention.
              </p>

              <div className="bg-white rounded-xl p-6 mb-6">
                <p className="font-semibold text-gray-900 mb-4">Who This is For</p>
                <ul className="space-y-2 text-gray-600">
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-secondary rounded-full mt-2 flex-shrink-0" />
                    Professionals looking to make intentional career moves
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-secondary rounded-full mt-2 flex-shrink-0" />
                    People in transition who need clarity and direction
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 bg-secondary rounded-full mt-2 flex-shrink-0" />
                    Anyone who wants a systematic approach to career growth
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 lg:order-1">
              <p className="font-semibold text-gray-900 mb-6">What You Get</p>
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Career Readiness Assessment</p>
                    <p className="text-sm text-gray-600">Evaluate where you stand and identify highest-impact moves</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Strategy Sessions</p>
                    <p className="text-sm text-gray-600">One-on-one coaching to clarify goals and build action plans</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Laboratory Method Framework</p>
                    <p className="text-sm text-gray-600">Systematic approach to skill building and career experimentation</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">Ongoing Coaching</p>
                    <p className="text-sm text-gray-600">Regular sessions to maintain momentum and adjust course</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-200">
                <p className="text-sm text-gray-500 mb-4">
                  Expected outcomes: Clearer direction, better positioning, faster skill development, more intentional career decisions.
                </p>
                <Link
