...
export default function AssessmentPage() {
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Send data to Make.com webhook (for email automation)
      const webhookData = {
        firstName: formData.firstName,
        lastName: formData.lastName,
        email: formData.email,
        ...
        score: currentScore,
        band: currentBand,
        bandLabel: currentProfile.level,
        answers: answers,
        dimensions: dimensionData,
        reportUrl: reportUrl,
      ...
      // Always save lead to Supabase (regardless of auth status)
      try {
        ...
        // Don't fail the form submission if lead capture fails
      }
            ...
            <div className="animate-fade-in">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-8">
                ...
                <p className="text-gray-700 mb-4">
                  A proven methodology for evaluating organizational AI maturity:
                </p>
                <div className="flex justify-between gap-1 mb-6">
                  {[
                    { letter: "A", word: "Assess" },
                    { letter: "S", word: "Strategize" },
                    { letter: "C", word: "Capability" },
                    { letter: "E", word: "Execution" },
                    { letter: "N", word: "Navigate" },
                    { letter: "D", word: "Deploy" },
                  ].map((item) => (
                    <div key={item.letter} className="bg-white border border-gray-200 rounded-lg px-2 py-2 text-center flex-1">
                      <span className="text-lg font-bold text-accent">{item.letter}</span>
                      <span className="text-[9px] text-gray-600 block">{item.word}</span>
                    </div>
                  ))}
                </div>
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-4">
                  <p className="text-xs font-semibold text-gray-900 mb-3">Scoring Guide (1-5):</p>
                  <div className="space-y-2 text-xs text-gray-600">
                    <div className="flex gap-2">
                      <span className="font-bold text-gray-900 w-4">1</span>
                      <span><strong>Not in place</strong> — No formal processes or policies exist</span>
                    </div>
                    <div className="flex gap-2">
                      <span className="font-bold text-gray-900 w-4">2</span>
                      <span><strong>Ad hoc</strong> — Done sometimes but no written policy or consistency</span>
                    </div>
                    <div className="flex gap-2">
                      <span className="font-bold text-gray-900 w-4">3</span>
                      <span><strong>Defined</strong> — Documented processes exist but not fully implemented</span>
                    </div>
                    <div className="flex gap-2">
                      <span className="font-bold text-gray-900 w-4">4</span>
                      <span><strong>Established</strong> — Consistently followed with regular review</span>
                    </div>
                    <div className="flex gap-2">
                      <span className="font-bold text-gray-900 w-4">5</span>
                      <span><strong>Optimized</strong> — Mature, measured, and continuously improved</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="animate-fade-in">
              ...
              {isSignedIn && isSaved ? (
                ...
                <div className="bg-gray-50 border border-gray-200 rounded-xl p-6 mb-8">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <p className="font-semibold text-gray-900">Save Your Results</p>
                      <p className="text-sm text-gray-600">Create a free account to save and track your progress over time</p>
                    </div>
                  </div>
                  <Link
                    href="/sign-up"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-accent text-white font-medium rounded-lg hover:bg-amber-600 transition-colors"
                  >
                    Create Free Account
                    <ArrowRight className="w-4 h-4" />
                  </Link>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-md mx-auto">
                  Schedule a complimentary session to review your results, discuss priorities, and plan your AI roadmap.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
                  ...
                  <Link
                    href="/solutions"
                    className="inline-flex items-center gap-2 px-8 py-4 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-accent hover:text-accent transition-all"
                  >
                ...
                <div className="pt-4 border-t border-gray-200">
                  <p className="text-sm text-gray-500 mb-3">Explore solutions for your industry:</p>
                  <div className="flex flex-wrap justify-center gap-4">
                    <Link href="/federal" className="text-sm text-accent font-medium hover:text-amber-600">
                      Federal & GovCon →
                    </Link>
                    <Link href="/healthcare" className="text-sm text-accent font-medium hover:text-amber-600">
                      Healthcare →
                    </Link>
                    <Link href="/enterprise" className="text-sm text-accent font-medium hover:text-amber-600">
                      Enterprise →
                    </Link>
                    <Link href="/associations" className="text-sm text-accent font-medium hover:text-amber-600">
                      Associations →
                    </Link>
                  </div>
                </div>
