            ...
            <div className="animate-fade-in">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-6 mb-8">
                ...
                <p className="text-gray-700 mb-6">
                  A proven methodology for evaluating and accelerating organizational AI maturity across six critical stages:
                </p>
                <div className="grid grid-cols-6 gap-2">
                  {[
                    ...
                    { letter: "N", word: "NAVIGATE", desc: "Change Management" },
            ...
            <div className="animate-fade-in">
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 text-center">
                ...
                <p className="text-gray-500 mb-6 max-w-md mx-auto">
                  Schedule a complimentary strategy session to review your results, discuss priorities, and plan next steps.
                </p>
