...
export const metadata: Metadata = {
  ...
  description: "Deploy AI with confidence. Working AI in 30 days. Governed production in 90. Take our free AI Readiness Assessment or book a strategy call.",
  ...
  openGraph: {
    ...
    description: "Deploy AI with confidence. Working AI in 30 days. Governed production in 90. Free AI Readiness Assessment.",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "JMCB Technology Group - AI Strategy & Implementation" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "JMCB Technology Group | AI Strategy & Implementation",
    description: "Deploy AI with confidence. Working AI in 30 days. Governed production in 90.",
    images: ["/og-image.png"],
  },
