...
import WhatsappBusinessToolYouAlreadyPayFor, {
  meta as whatsappBusinessToolYouAlreadyPayForMeta,
} from "./whatsapp-business-tool-you-already-pay-for";
...
export const insightsPosts: InsightsPost[] = [
  ...
  { meta: whatsappBusinessToolYouAlreadyPayForMeta, Component: WhatsappBusinessToolYouAlreadyPayFor },
