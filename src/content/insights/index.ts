...
import WhatADigitalPassengerManifestWouldHaveChanged, {
  meta as whatADigitalPassengerManifestWouldHaveChangedMeta,
} from "./what-a-digital-passenger-manifest-would-have-changed";
...
export const insightsPosts: InsightsPost[] = [
  ...
  {
    meta: whatADigitalPassengerManifestWouldHaveChangedMeta,
    Component: WhatADigitalPassengerManifestWouldHaveChanged,
  },
